...
const GalleryBlogCard = ({ galleryData }) => {

    const navigate = useNavigate();
    const { title, author, date, details, blog_id, image } = galleryData || {};
    ...
    return (
        <div className="relative h-[537px]  bg-white shadow-lg overflow-hidden">
            ...
            <div
                onClick={() => navigate(`/blogs/রক্তবন্ধু-গ্যালারি/${blog_id}`)}
...
export default GalleryBlogCard;