    ...
    return (
        <section>
          ...
          <table className='table-auto border-separate border-spacing-x-0.5 border-spacing-y-0.5 border border-black mx-auto mt-8 lg:mb-24'>
                ...
                <tbody>
                  {Data.map(dt => <tr className='text-black text-sm'> <td className='p-2 font-bold '> {dt.num} </td> <td className='p-2'> {dt.name} </td> <td className='p-2'> <p>{dt.dist_address}</p> <p>{dt.vill_address} </p> </td> <td className='p-2'> {dt.phone_number} </td> <td className='p-2'> {dt.last_donate_date} </td> </tr>)}
                </tbody>
          </table>
          <Footer />
        </section>
