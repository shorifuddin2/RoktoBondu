                ...
                <div className="navbar-start ">
                    <div className="dropdown">
                        ...
                        <ul tabIndex={0} className="menu menu-compact dropdown-content mt-3 shadow bg-base-100 rounded-box w-52 text-red-500 font-bold">
                            ...
                            <li className='hover m-2'><Link to="/blogs/ক্যাম্পেইন নিউজ">ক্যাম্পেইন নিউজ</Link></li>
                            <li className='hover m-2'><Link to="/blogs/প্রথম-রক্তদান">প্রথম রক্তদান </Link></li>
                            <li className='hover m-2'><Link to="/blogs/রক্তদানের-অভিজ্ঞতা">রক্তদানের অভিজ্ঞতা </Link></li>
                            <li className='hover m-2'><Link to="/blogs/রক্তদানের-গল্প">রক্তদানের গল্প</Link></li>
                            <li className='hover m-2'><Link to="/blogs/রক্তবন্ধু গ্যালারি">রক্তবন্ধু গ্যালারি</Link></li>
