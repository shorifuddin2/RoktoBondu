  ...
  const [platelets] = usePlatelet()
    ...
    return (
      ...
      <div className='lg:mx-28 md:mx-16 sm:mx-24 xs:mx-5 mt-16'>
          <h1 className='text-base-100 text-center mb-24'><span className='bg-primary lg:px-10 md:px-5 sm:px-3 py-2 rounded-full lg:text-xl md:text-xl sm:text-sm font-bold'> A+ প্লাটিলেট রক্তবন্ধুর তালিকা</span></h1>
