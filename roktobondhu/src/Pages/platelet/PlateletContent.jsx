      ...
      <div className="lg:mx-28 sm:mx-10 md:mx-24 xs:mx-5 mt-16">
                  ...
                  <div>
                    <Link to="/all-platelet-search">
                      <input
                        type="submit"
                        value="খুঁজুন"
                        className="bg-primary px-10 text-base-100 font-bold rounded-full btn mt-5"
                      />
                    </Link>
                  </div>
                </div>
            ...
            <div className="flex items-center justify-center sm:mt-5">
              <div>
                <div className="lg:ml-0 md:ml-0 sm:ml-0 xs:ml-10 lg:flex md:flex sm:flex items-center gap-x-5">
                  ...
                  <div>
                    <button className="bg-secondary text-base-100 px-8 rounded-full py-2 sm:mt-3">
                ...
                <div className="flex flex-col items-center mt-10">
                  ...
                  <div className="mt-2">
                    <button
                      className=" text-base-100 px-8 rounded-full py-2"
        ...
        <section>
          <div className="border shadow-lg border-primary mt-96">
            <h1 className="text-base-100 bg-primary text-center py-4">
              একটু জেনে নিন...
            </h1>
            <div className="text-black lg:p-10 md:p-10 sm:p-5 xs:p-5">
              <p>
                যারা শুধু প্লাটিলেট/অণুচক্রিকা প্রদান করেন আমরা জানি ১৫ দিন পরপর
                প্লাটিলেট দেয়া যায়। কিন্তু আমাদের আবহাওয়া পরিবেশ ও
                খাদ্যাভ্যাস এবং জীবনাচরণের ভিত্তিতে মাসে ১ বার দেয়াই উত্তম। সে
                হিসেবে রক্তবন্ধুতে ৩০ দিন পরপর প্লাটিলেট দিতে প্রস্তুত প্লাটিলেট
                দাতাদের লিস্টে দেখানো হবে। ৩০ দিনের কম হলে নাম কাটা অবস্থায় দেখা
                যাবে। তবে কারো শরীর স্বাস্থ্য ভালো হলে এবং খুব জরুরি রোগির
                ক্ষেত্রে ১৫-২০ দিন পরই চাইলে দিতে পারেন। ঢাকা, কুমিল্লা, সিলেট ও
                চট্টগ্রাম এর বাইরে যেহেতু এফেরেসিস এর মাধ্যমে শুধু প্লাটিলেট
                দেয়ার সুযোগ নেই তাই আপাতত এই চারটি জেলা যুক্ত করা হলো। আশেপাশের
                জেলার যারা এই চারটি লোকেশনে প্লাটিলেট দিতে পারবেন তারাও
                রেজিস্ট্রেশন করুন। প্রতিবার প্লাটিলেট দেয়ার পর লগইন করে তারিখ
                আপডেট করে দিবেন। অন্যকোন জেলায় এফেরেসিস মেশিনের মাধ্যমে শুধু
                প্লাটিলেট/অণুচক্রিকা নেয়ার ব্যবস্থা চালু হলে আমাদের জানাবেন,
                আমরা সেই জেলা যুক্ত করে দিবো।
              </p>
              <p className="mt-8">
                <span className="font-bold">প্লাটিলেট ডোনারের যোগ্যতাঃ</span>{" "}
                বয়স কমপক্ষে ১৮, ওজন ৬০ কেজি ও ভেইন বা রগ স্পষ্ট/ তুলনামূলক মোটা
                হতে হবে। হিমোগ্লোবিন কমপক্ষে ১২.৫ ও প্লাটিলেট কাউন্ট ন্যূনতম
                ২,২০,০০০ (দুই লক্ষ বিশ হাজার) হতে হবে। যা হাসপাতালে চেক করে নেয়া
                হবে।
              </p>
              <h5 className="text-center mt-8">
                <button className="rounded hover:bg-primary bg-primary text-base-100 px-5 py-2 cursor-pointer">
